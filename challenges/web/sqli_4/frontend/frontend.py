...
class DBManager:
    ...
    def populate_db(self):
        ...
        self.cursor.executemany(f'INSERT INTO users (username, password) VALUES (%s, %s);', [('admin', 'UMASS{OTHERFLAG}'), ('user1', 'password1')])
...
def index():
    ...
    if session.get('user'):
        return render_template('index.html', message=f"You are logged in!")
