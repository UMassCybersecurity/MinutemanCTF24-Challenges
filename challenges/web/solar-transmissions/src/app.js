...
app.get('/clear',async (req,res)=>{
  if(!req.cookies || !req.cookies.user || !(typeof myVar === 'string') || !(await client.exists(req.cookies.user))){
...
app.post('/create',async (req,res)=>{
  if(!req.cookies || !req.cookies.user || !(typeof myVar === 'string') || !(client.exists(req.cookies.user))){
    return res.send("Hmm are you even a user? Go to /");
  }
  if(!req.body.note){
